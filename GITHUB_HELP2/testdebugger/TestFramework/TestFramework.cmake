...
if (NOT CROSS_COMPILE_ARM AND (Vulkan_FOUND OR WIN32 OR ("${CMAKE_SYSTEM_NAME}" MATCHES "Darwin")))
	...
	# Root
	set(TEST_FRAMEWORK_ROOT ${PROJECT_SOURCE_DIR}/testdebugger/TestFramework)
	...
	if (WIN32)
		...
		set(TEST_FRAMEWORK_SRC_FILES_SHADERS
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/DX/VertexConstants.h
		)
		set(TEST_FRAMEWORK_HLSL_VERTEX_SHADERS
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/DX/FontVertexShader.hlsl
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/DX/LineVertexShader.hlsl
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/DX/TriangleDepthVertexShader.hlsl
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/DX/TriangleVertexShader.hlsl
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/DX/UIVertexShader.hlsl
		)
		...
		set(TEST_FRAMEWORK_HLSL_PIXEL_SHADERS
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/DX/FontPixelShader.hlsl
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/DX/LinePixelShader.hlsl
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/DX/TriangleDepthPixelShader.hlsl
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/DX/TrianglePixelShader.hlsl
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/DX/UIPixelShader.hlsl
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/DX/UIPixelShaderUntextured.hlsl
		)
	...
	if ("${CMAKE_SYSTEM_NAME}" MATCHES "Darwin")
		...
		# Metal shaders
		set(TEST_FRAMEWORK_SRC_FILES_SHADERS
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/MTL/VertexConstants.h
		)
		set(TEST_FRAMEWORK_METAL_SHADERS
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/MTL/FontShader.metal
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/MTL/LineShader.metal
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/MTL/TriangleShader.metal
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/MTL/UIShader.metal
		)
		...
		# Link Metal shaders
		set(TEST_FRAMEWORK_METAL_LIB ${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/MTL/Shaders.metallib)
	...
	if (Vulkan_FOUND)
		...
		set(TEST_FRAMEWORK_SRC_FILES_SHADERS
			...
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/VK/VertexConstants.h
		)
		set(TEST_FRAMEWORK_GLSL_SHADERS
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/VK/FontVertexShader.vert
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/VK/LineVertexShader.vert
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/VK/TriangleDepthVertexShader.vert
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/VK/TriangleVertexShader.vert
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/VK/UIVertexShader.vert
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/VK/FontPixelShader.frag
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/VK/LinePixelShader.frag
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/VK/TriangleDepthPixelShader.frag
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/VK/TrianglePixelShader.frag
			${PROJECT_SOURCE_DIR}/testdebugger/Assets/Shaders/VK/UIPixelShader.frag
	...
	set(TEST_FRAMEWORK_ASSETS
		${PROJECT_SOURCE_DIR}/testdebugger/Assets/Fonts/Roboto-Regular.ttf
		${PROJECT_SOURCE_DIR}/testdebugger/Assets/UI.tga
		${TEST_FRAMEWORK_SRC_FILES_SHADERS}
	...
	# Group shader files
	source_group(TREE ${PROJECT_SOURCE_DIR}/testdebugger FILES ${TEST_FRAMEWORK_SRC_FILES_SHADERS} ${TEST_FRAMEWORK_GLSL_SHADERS} ${TEST_FRAMEWORK_METAL_SHADERS})
	...
	if ("${CMAKE_SYSTEM_NAME}" MATCHES "Darwin")
		...
		foreach(ASSET_FILE ${TEST_FRAMEWORK_ASSETS})
			string(REPLACE ${PROJECT_SOURCE_DIR}/testdebugger/Assets "Resources" ASSET_DST ${ASSET_FILE})
